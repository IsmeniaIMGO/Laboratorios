...
public class Cliente {
	...
	public static final String SERVER = "localhost"; //definimos la direccion ip del servidor
	public static final int PORT = 3400; //definimos el puerto por donde se van a comunicar el cliente y el servidor
