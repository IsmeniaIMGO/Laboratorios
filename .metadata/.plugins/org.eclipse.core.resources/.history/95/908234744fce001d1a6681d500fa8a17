...
public class Banco implements ICrudUsuario, ICrudCuenta, ITransaccionesCuenta {
	/**
	 * Atributos
	 */
	 ...
	 * que me permite crear un usuario y 
	 * agregarlo al banco
	 */
	@Override
	...
	/**
	 * Metodo implementado del paquete de servicios 
	 * que me consulta si un usuario existe o no en el banco
	 */
	@Override
